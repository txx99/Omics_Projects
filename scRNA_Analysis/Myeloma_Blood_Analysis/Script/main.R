...
markers<-FindAllMarkers(sdf,
                        logfc.threshold = 0.25, # min log2fc avg expression  
                        min.pct = 0.1) # min % of cells in cluster that must present the gene
...
# Visualise markers vs cell signatures --------

# FeatuerPlots of specific cell type markers
